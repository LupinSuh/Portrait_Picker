pub mod highgui {
	...
	///
	/// ## Note
	/// This alternative version of [select_roi_for_window] function uses the following default values for its arguments:
	/// * show_crosshair: true
	/// * from_center: false
	#[inline]
	pub fn select_roi_for_window_def(window_name: &str, img: &impl ToInputArray) -> Result<core::Rect> {
		extern_container_arg!(window_name);
		input_array_arg!(img);
		return_send!(via ocvrs_return);
	...
	/// * from_center: false
	#[inline]
	pub fn select_roi_for_window(window_name: &str, img: &impl ToInputArray, show_crosshair: bool, from_center: bool) -> Result<core::Rect> {
		extern_container_arg!(window_name);
		input_array_arg!(img);
		return_send!(via ocvrs_return);
	...
	/// * from_center: false
	#[inline]
	pub fn select_roi_def(img: &impl ToInputArray) -> Result<core::Rect> {
		input_array_arg!(img);
		return_send!(via ocvrs_return);
	...
	/// * from_center: false
	#[inline]
	pub fn select_roi(img: &impl ToInputArray, show_crosshair: bool, from_center: bool) -> Result<core::Rect> {
		input_array_arg!(img);
		return_send!(via ocvrs_return);
	...
	///
	/// ## Note
	/// This alternative version of [select_rois] function uses the following default values for its arguments:
	/// * show_crosshair: true
	/// * from_center: false
	#[inline]
	pub fn select_rois_def(window_name: &str, img: &impl ToInputArray, bounding_boxes: &mut core::Vector<core::Rect>) -> Result<()> {
		extern_container_arg!(window_name);
		input_array_arg!(img);
		return_send!(via ocvrs_return);
	...
	/// * from_center: false
	#[inline]
	pub fn select_rois(window_name: &str, img: &impl ToInputArray, bounding_boxes: &mut core::Vector<core::Rect>, show_crosshair: bool, from_center: bool) -> Result<()> {
		extern_container_arg!(window_name);
		input_array_arg!(img);
		return_send!(via ocvrs_return);
