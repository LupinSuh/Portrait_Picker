...
/// * stream: Stream::Null()
#[inline]
pub fn fast_nl_means_denoising_colored_def(src: &core::GpuMat, dst: &mut core::GpuMat, h_luminance: f32, photo_render: f32) -> Result<()> {
...
/// * stream: Stream::Null()
#[inline]
pub fn fast_nl_means_denoising_colored(src: &core::GpuMat, dst: &mut core::GpuMat, h_luminance: f32, photo_render: f32, search_window: i32, block_size: i32, stream: &mut core::Stream) -> Result<()> {
	return_send!(via ocvrs_return);
...
/// * stream: Stream::Null()
#[inline]
pub fn fast_nl_means_denoising_def(src: &core::GpuMat, dst: &mut core::GpuMat, h: f32) -> Result<()> {
	return_send!(via ocvrs_return);
...
/// * stream: Stream::Null()
#[inline]
pub fn fast_nl_means_denoising(src: &core::GpuMat, dst: &mut core::GpuMat, h: f32, search_window: i32, block_size: i32, stream: &mut core::Stream) -> Result<()> {
	return_send!(via ocvrs_return);
...
/// * stream: Stream::Null()
#[inline]
pub fn non_local_means_def(src: &core::GpuMat, dst: &mut core::GpuMat, h: f32) -> Result<()> {
	return_send!(via ocvrs_return);
...
/// * stream: Stream::Null()
#[inline]
pub fn non_local_means(src: &core::GpuMat, dst: &mut core::GpuMat, h: f32, search_window: i32, block_size: i32, border_mode: i32, stream: &mut core::Stream) -> Result<()> {
	return_send!(via ocvrs_return);
