...
//! of the codewords are multiplexed in time [pattern](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_pattern) .
//! 
//! In this module a time-multiplexing coding strategy based on Gray encoding is implemented following the
//! (stereo) approach described in 3DUNDERWORLD algorithm [UNDERWORLD](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_UNDERWORLD) .
...
/// Class implementing the Gray-code pattern, based on [UNDERWORLD](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_UNDERWORLD).
/// 
...
/// and Fourier-assisted phase-shifting profilometry (FAPS) based on [faps](https://docs.opencv.org/4.12.0/d0/de3/citelist.html#CITEREF_faps).
/// 
