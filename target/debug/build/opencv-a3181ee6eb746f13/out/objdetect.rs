...
pub trait ArucoDetectorTraitConst: core::AlgorithmTraitConst {
	...
	#[inline]
	fn detect_markers_multi_dict(&self, image: &impl core::ToInputArray, corners: &mut impl core::ToOutputArray, ids: &mut impl core::ToOutputArray, rejected_img_points: &mut impl core::ToOutputArray, dict_indices: &mut impl core::ToOutputArray) -> Result<()> {
		input_array_arg!(image);
		output_array_arg!(corners);
		output_array_arg!(ids);
		output_array_arg!(rejected_img_points);
	...
	/// * dict_indices: noArray()
	#[inline]
	fn detect_markers_multi_dict_def(&self, image: &impl core::ToInputArray, corners: &mut impl core::ToOutputArray, ids: &mut impl core::ToOutputArray) -> Result<()> {
		input_array_arg!(image);
		output_array_arg!(corners);
		output_array_arg!(ids);
		return_send!(via ocvrs_return);
...
impl ArucoDetector {
	...
	/// * refine_params: RefineParameters()
	#[inline]
	pub fn new_1(dictionaries: &core::Vector<crate::objdetect::Dictionary>, detector_params: &crate::objdetect::DetectorParameters, refine_params: crate::objdetect::RefineParameters) -> Result<crate::objdetect::ArucoDetector> {
		return_send!(via ocvrs_return);
