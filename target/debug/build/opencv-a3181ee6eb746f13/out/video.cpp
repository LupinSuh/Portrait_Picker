...
extern "C" {
	...
	void cv_TrackerDaSiamRPN_create_const_NetR_const_NetR_const_NetR(const cv::dnn::Net* siam_rpn, const cv::dnn::Net* kernel_cls1, const cv::dnn::Net* kernel_r1, Result<cv::Ptr<cv::TrackerDaSiamRPN>*>* ocvrs_return) {
		try {
			cv::Ptr<cv::TrackerDaSiamRPN> ret = cv::TrackerDaSiamRPN::create(*siam_rpn, *kernel_cls1, *kernel_r1);
			Ok(new cv::Ptr<cv::TrackerDaSiamRPN>(ret), ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_TrackerGOTURN_create_const_NetR(const cv::dnn::Net* model, Result<cv::Ptr<cv::TrackerGOTURN>*>* ocvrs_return) {
		try {
			cv::Ptr<cv::TrackerGOTURN> ret = cv::TrackerGOTURN::create(*model);
			Ok(new cv::Ptr<cv::TrackerGOTURN>(ret), ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_TrackerNano_create_const_NetR_const_NetR(const cv::dnn::Net* backbone, const cv::dnn::Net* neckhead, Result<cv::Ptr<cv::TrackerNano>*>* ocvrs_return) {
		try {
			cv::Ptr<cv::TrackerNano> ret = cv::TrackerNano::create(*backbone, *neckhead);
			Ok(new cv::Ptr<cv::TrackerNano>(ret), ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_TrackerVit_create_const_NetR_Scalar_Scalar_float(const cv::dnn::Net* model, cv::Scalar* meanvalue, cv::Scalar* stdvalue, float tracking_score_threshold, Result<cv::Ptr<cv::TrackerVit>*>* ocvrs_return) {
		try {
			cv::Ptr<cv::TrackerVit> ret = cv::TrackerVit::create(*model, *meanvalue, *stdvalue, tracking_score_threshold);
			Ok(new cv::Ptr<cv::TrackerVit>(ret), ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	
	void cv_TrackerVit_create_const_NetR(const cv::dnn::Net* model, Result<cv::Ptr<cv::TrackerVit>*>* ocvrs_return) {
		try {
			cv::Ptr<cv::TrackerVit> ret = cv::TrackerVit::create(*model);
			Ok(new cv::Ptr<cv::TrackerVit>(ret), ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
