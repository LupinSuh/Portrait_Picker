...
impl TrackerDaSiamRPN {
	...
	#[inline]
	pub fn create_1(siam_rpn: &crate::dnn::Net, kernel_cls1: &crate::dnn::Net, kernel_r1: &crate::dnn::Net) -> Result<core::Ptr<crate::video::TrackerDaSiamRPN>> {
		return_send!(via ocvrs_return);
...
impl TrackerGOTURN {
	...
	#[inline]
	pub fn create_1(model: &crate::dnn::Net) -> Result<core::Ptr<crate::video::TrackerGOTURN>> {
		return_send!(via ocvrs_return);
...
impl TrackerNano {
	...
	#[inline]
	pub fn create_1(backbone: &crate::dnn::Net, neckhead: &crate::dnn::Net) -> Result<core::Ptr<crate::video::TrackerNano>> {
		return_send!(via ocvrs_return);
...
impl TrackerVit {
	...
	#[inline]
	pub fn create_1(model: &crate::dnn::Net, meanvalue: core::Scalar, stdvalue: core::Scalar, tracking_score_threshold: f32) -> Result<core::Ptr<crate::video::TrackerVit>> {
		return_send!(via ocvrs_return);
		unsafe { sys::cv_TrackerVit_create_const_NetR_Scalar_Scalar_float(model.as_raw_Net(), meanvalue.opencv_as_extern(), stdvalue.opencv_as_extern(), tracking_score_threshold, ocvrs_return.as_mut_ptr()) };
		return_receive!(unsafe ocvrs_return => ret);
		let ret = ret.into_result()?;
		let ret = unsafe { core::Ptr::<crate::video::TrackerVit>::opencv_from_extern(ret) };
		Ok(ret)
	...
	/// * tracking_score_threshold: 0.20f
	#[inline]
	pub fn create_def_1(model: &crate::dnn::Net) -> Result<core::Ptr<crate::video::TrackerVit>> {
		return_send!(via ocvrs_return);
